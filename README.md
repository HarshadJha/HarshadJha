...
public class Harshad extends Developer {
    ...
    String[] focus     = { "Full Stack Web Development", "DSA", "Backend Design" };
    String[] learning  = { "System Design", "Spring Boot", "Cloud Architecture" };
    String   goal      = "Land a Software Engineering Internship / Entry-Level Role";
    boolean  openToWork = true;

    @Override
    public String introduce() {
        return "CS undergrad who loves building things that actually work in production.";
    }
}
```

- 🎓 **CS Undergraduate** focused on backend + frontend integration
- 🔭 Currently building **production-level full stack projects**
- 🌱 Deepening expertise in **Spring Boot, DSA, and System Design**
...
```
📌  Sharpening DSA — Arrays, Trees, Graphs, DP
